...
$sql_value = strip_tags($_POST['sql1']);
if($db_name_value ==''){
...
if($sql) {
  ...
  echo "<script>alert('SQL Executed Ok');

sessionStorage.setItem('access_tb', '$tb_name_value');
...
echo "<div style='color:white;background:green;padding:10px;border:none;' id='sql_ok1'>SQL Executed successfully </b></div><br>";
} else {
  echo "<div style='color:white;background:red;padding:10px;border:none;' id='sql_failed1'>SQL Execution failed</div><br>";
}
